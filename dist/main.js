...
// src/deleteMeUtils/addDeleteMeFile.ts
var deleteFile = "DELETE_ME.md";
function addDeleteMeFile(branch) {
  (0, import_fs.writeFileSync)(deleteFile, [
    ":warning::warning::warning:",
...
function getChangelogEntry(version) {
  const changelog = (0, import_fs5.readFileSync)("./CHANGELOG.md", "utf-8").split("\n");
